...
import App from './App'
import { render, queryByAttribute, fireEvent, cleanup } from '@testing-library/react'
...
it('Render Complete App with all screen with Prev and Next ', async () => {
	...
	const linkElement2 = await getByText(/Enter Receiver's Address/i)
	...
	const linkElementR = weightScreen(/Enter Weight/i)
	...
	const finalScreenElement = finalScreen(/Shipping Label Order Details/i)
